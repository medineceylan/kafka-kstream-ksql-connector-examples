...
public class AccountBalance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AccountBalance\",\"namespace\":\"com.medineceylan.kafkaexamples.models\",\"fields\":[{\"name\":\"customer_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"amount\",\"type\":\"double\",\"default\":0}]}");
   ...
   */
  public static com.medineceylan.kafkaexamples.models.AccountBalance.Builder newBuilder() {
    return new com.medineceylan.kafkaexamples.models.AccountBalance.Builder();
  }
   ...
   * @return A new AccountBalance RecordBuilder
   */
  public static com.medineceylan.kafkaexamples.models.AccountBalance.Builder newBuilder(com.medineceylan.kafkaexamples.models.AccountBalance.Builder other) {
    return new com.medineceylan.kafkaexamples.models.AccountBalance.Builder(other);
  }
   ...
   * @return A new AccountBalance RecordBuilder
   */
  public static com.medineceylan.kafkaexamples.models.AccountBalance.Builder newBuilder(com.medineceylan.kafkaexamples.models.AccountBalance other) {
    return new com.medineceylan.kafkaexamples.models.AccountBalance.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountBalance>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.medineceylan.kafkaexamples.models.AccountBalance.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.medineceylan.kafkaexamples.models.AccountBalance other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.customer_id)) {
        this.customer_id = data().deepCopy(fields()[0].schema(), other.customer_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.medineceylan.kafkaexamples.models.AccountBalance.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.medineceylan.kafkaexamples.models.AccountBalance.Builder clearCustomerId() {
      customer_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.medineceylan.kafkaexamples.models.AccountBalance.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.medineceylan.kafkaexamples.models.AccountBalance.Builder clearAmount() {
